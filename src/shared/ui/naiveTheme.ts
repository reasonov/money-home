...
const light: GlobalThemeOverrides = {
  ...
  Button: {
    ...
    colorSecondaryHover: '#99F6E4',
    colorSecondaryPressed: '#99F6E4',
    textColorSecondary: '#0F766E',
    textColorSecondaryHover: '#0F766E',
    textColorSecondaryPressed: '#0F766E',
    borderSecondary: '1px solid #0F766E',
    borderSecondaryHover: '1px solid #0F766E',
    borderSecondaryPressed: '1px solid #0F766E',
  },
  Input: {
    heightLarge: '48px',
    ...CONTROL_FONT,
...
const dark: GlobalThemeOverrides = {
  ...
  Button: {
    ...
    fontWeightStrong: '600',
    paddingLarge: '0 16px',
    colorSecondary: 'rgba(42, 155, 144, 0.18)',
    colorSecondaryHover: 'rgba(42, 155, 144, 0.28)',
    colorSecondaryPressed: 'rgba(42, 155, 144, 0.18)',
    textColorSecondary: '#2A9B90',
    textColorSecondaryHover: '#2A9B90',
    textColorSecondaryPressed: '#2A9B90',
    borderSecondary: '1px solid #2A9B90',
    borderSecondaryHover: '1px solid #34B3A6',
    borderSecondaryPressed: '1px solid #2A9B90',
  },
  Input: {
    heightLarge: '48px',
    ...CONTROL_FONT,
