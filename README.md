...
Семейное PWA для планирования покупок из общего бюджета.
...
Опционально для будущей связки с Supabase: secrets `VITE_SUPABASE_URL` и `VITE_SUPABASE_ANON_KEY` в настройках репозитория.